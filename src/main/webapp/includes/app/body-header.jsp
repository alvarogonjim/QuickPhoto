<header>
         <ul id="nav-mobile" class="side-nav fixed">
            <div class="logo" ><a id="logo-container" href="/index.html" class="brand-logo" style="font-size:2.1rem; color:#fff; text-align:center;">
               <b>Quick</b><span class="fa fa-picture-o" aria-hidden="true"></span>Photo</a>
            </div>
            <li class="no-padding">
