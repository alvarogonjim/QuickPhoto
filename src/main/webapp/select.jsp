            ...
            <div class="col s12 m6 l4 xl2">
               <div class="card">
                  <div class="card-image" style="height: 200px">
                     ...
                     <a class="btn-floating halfway-fab waves-effect waves-light pink" onClick="return launchEditor('${ file.id }', 'https://drive.google.com/uc?id=${file.id}&export=download');">      
